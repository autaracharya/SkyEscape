...
//            // Load game if 'C' is pressed
//            if (keyboardState.IsKeyDown(Keys.C))
//            {
//                LoadGameProgress();  // Load saved game if exists, otherwise start fresh
//                currentState = GameState.Play;
//            }

//            // Trigger the save data clear when "D" is pressed
//            if (keyboardState.IsKeyDown(Keys.D))
//            {
//                DeleteSavedGame();  // Delete saved game file
//                currentState = GameState.EnterName;  // Go to EnterName to start fresh
//            }
//        }
...
//                _playerName = gameStateData.Name;
//                _score = gameStateData.Score;
//                _difficultyLevel = gameStateData.Level;
//                _birdPosition = new Vector2(gameStateData.PlayerX, gameStateData.PlayerY);
...
//            else
//            {
//                // If no saved game exists, go to the EnterName scene
...
//            // If the countdown is active, handle countdown logic
...
//                {
//                    _countdown--;
//                    _countdownTimer = 1f;  // Reset timer for the next countdown step

//                    // When countdown reaches 0, stop the countdown
//                    if (_countdown <= 0)
//                    {
//                        _isCountdownActive = false;
//                        // Start the game after countdown
//                        _score = 0;  // Reset score or continue based on your needs
//                        _difficultyLevel = 1;  // Set difficulty level
//                                               // Initialize other game variables as needed
//                    }
//                }
//            }

//            // Other gameplay logic (if countdown is finished, continue normal game)
//            if (!_isCountdownActive)
//            {
//                // Game logic when countdown is finished (normal game play)
//                UpdateBirdMovement();
//                UpdateBirdMovement();
...
//            // Handle ESC and save progress
//            if (keyboardState.IsKeyDown(Keys.Escape))
//            {
//                SaveGameProgress();  // Save the game state
//                currentState = GameState.Start;  // Return to Start Scene
//            }
//        }

//        private void SaveGameProgress()
//        {
//            GameStateData gameStateData = new GameStateData(_playerName, _score, _difficultyLevel, _birdPosition.X, _birdPosition.Y);
//            GameSaveManager saveManager = new GameSaveManager();
//            saveManager.SaveGame(gameStateData);
//        }
...
//            // Menu options
//            _spriteBatch.DrawString(_font, "Press Enter to Start", new Vector2(250, 350), Color.LightGoldenrodYellow);
...
//            // Display continue option if a saved game exists
//            _spriteBatch.DrawString(_font, "Press C to Continue", new Vector2(250, 500), Color.LightCoral);
//        }
...
//                _spriteBatch.DrawString(_font, countdownText, position, Color.White);
//            }

//            // Draw score and top score
//            _spriteBatch.DrawString(_font, $"Score: {_score} (Level: {_difficultyLevel})", new Vector2(10, 10), Color.Black);
//            _spriteBatch.DrawString(_font, $"Top Score: {GetTopScore()}", new Vector2(10, 30), Color.White);
//        }

//        private string GetTopScore()
//        {
//            // You can replace this with your logic to get the top score from saved high scores
//            return _highScores.FirstOrDefault()?.Score.ToString() ?? "0";
//        }
...
//        {
//            string saveFilePath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments), "SkyEscape", "game_save.txt");

//            if (File.Exists(saveFilePath))
//            {
//                File.Delete(saveFilePath);  // Delete the saved game file
//                Console.WriteLine("Saved game data cleared.");
//            }
//        }
